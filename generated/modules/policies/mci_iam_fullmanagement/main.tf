...
# MCI-IAM-FullManagement Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment/MCI-IAM-FullManagement.yaml
resource "aws_iam_policy" "main" {
  name        = "mci-iam-fullmanagement"
  path        = "/"
  ...
  tags = merge(var.common_tags, {
    Name = "mci-iam-fullmanagement-${var.environment}"
    Type = "Policy"
  })
}