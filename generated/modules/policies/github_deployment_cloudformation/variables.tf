# Variables for github-deployment-cloudformation Policy Module

variable "policy_description" {
  description = "Description for the github-deployment-cloudformation policy"
  type        = string
  default     = "Permisos para despliegues con CloudFormation, KMS encryption y servicios adicionales"
}
