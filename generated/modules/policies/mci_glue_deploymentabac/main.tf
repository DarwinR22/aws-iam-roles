...
# MCI-Glue-DeploymentABAC Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment\MCI-Glue-DeploymentABAC.yaml
resource "aws_iam_policy" "main" {
  name        = "mci-mci-glue-deploymentabac"
  path        = "/policies/"
...
Effect = "Allow"
  ...
  tags = merge(var.common_tags, {
    Name = "mci-glue-deploymentabac-${var.environment}"
    Type = "Policy"
  })
}