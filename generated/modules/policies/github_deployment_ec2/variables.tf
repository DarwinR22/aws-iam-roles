# Variables for github-deployment-ec2 Policy Module

variable "policy_description" {
  description = "Description for the github-deployment-ec2 policy"
  type        = string
  default     = "Permisos EC2 y VPC para GitHub Actions deployment con SGSI"
}
