...
# github-deployment-dynamodb Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment/github-deployment-dynamodb.yaml
resource "aws_iam_policy" "main" {
  name        = "github-deployment-dynamodb"
  path        = "/"
  ...
  tags = merge(var.common_tags, {
    Name = "github-deployment-dynamodb-${var.environment}"
    Type = "Policy"
  })
}