# Variables for github-deployment-application Policy Module

variable "policy_description" {
  description = "Description for the github-deployment-application policy"
  type        = string
  default     = "Política consolidada de servicios de aplicación (Lambda, S3, DynamoDB, EventBridge) para GitHub Actions deployment con control ABAC basado en tags"
}
