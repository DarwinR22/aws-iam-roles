# Variables for mci-lambda-sns-publish Policy Module

variable "policy_description" {
  description = "Description for the mci-lambda-sns-publish policy"
  type        = string
  default     = "Permite a Lambda publicar mensajes en SNS Topics con control ABAC basado en tags Gerencia y Ambiente"
}
