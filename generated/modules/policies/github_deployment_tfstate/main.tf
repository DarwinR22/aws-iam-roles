...
# github-deployment-tfstate Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment\github-deployment-tfstate.yaml
...
Effect = "Allow"
  ...
  tags = merge(var.common_tags, {
    Name = "github-deployment-tfstate-${var.environment}"
    Type = "Policy"
  })
}