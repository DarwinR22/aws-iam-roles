...
# github-deployment-lambda Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment/github-deployment-lambda.yaml
resource "aws_iam_policy" "main" {
  name        = "github-deployment-lambda"
  path        = "/"
  ...
  tags = merge(var.common_tags, {
    Name = "github-deployment-lambda-${var.environment}"
    Type = "Policy"
  })
}