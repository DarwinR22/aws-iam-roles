...
# github-deployment-eventbridge Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment\github-deployment-eventbridge.yaml
resource "aws_iam_policy" "main" {
  name        = "github-deployment-eventbridge"
  path        = "/"
...
Effect = "Allow"
  ...
  tags = merge(var.common_tags, {
    Name = "github-deployment-eventbridge-${var.environment}"
    Type = "Policy"
  })
}