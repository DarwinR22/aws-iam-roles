# Variables for mci-lambda-cloudwatch-logs Policy Module

variable "policy_description" {
  description = "Description for the mci-lambda-cloudwatch-logs policy"
  type        = string
  default     = "Permite a Lambda escribir logs en CloudWatch con control ABAC basado en tags Gerencia y Ambiente"
}
