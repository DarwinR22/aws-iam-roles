...
# MCI-IAM-Deployment Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment\MCI-IAM-Deployment.yaml
resource "aws_iam_policy" "main" {
  name        = "mci-iam-deployment"
  path        = "/"
...
Effect = "Allow"
  ...
  tags = merge(var.common_tags, {
    Name = "mci-iam-deployment-${var.environment}"
    Type = "Policy"
  })
}