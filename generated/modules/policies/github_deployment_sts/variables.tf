# Variables for github-deployment-sts Policy Module

variable "policy_description" {
  description = "Description for the github-deployment-sts policy"
  type        = string
  default     = "Permisos STS necesarios para GitHub Actions OIDC"
}
