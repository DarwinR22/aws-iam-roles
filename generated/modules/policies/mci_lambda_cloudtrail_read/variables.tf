# Variables for mci-lambda-cloudtrail-read Policy Module

variable "policy_description" {
  description = "Description for the mci-lambda-cloudtrail-read policy"
  type        = string
  default     = "Permite a Lambda de seguridad leer eventos CloudTrail con control ABAC por Gerencia y Dominio"
}
