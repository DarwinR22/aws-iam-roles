...
# github-deployment-s3 Policy Module - Following ABAC Pattern
# Converted from definitions/policies/deployment/github-deployment-s3.yaml
resource "aws_iam_policy" "main" {
  name        = "github-deployment-s3"
  path        = "/"
  ...
  tags = merge(var.common_tags, {
    Name = "github-deployment-s3-${var.environment}"
    Type = "Policy"
  })
}